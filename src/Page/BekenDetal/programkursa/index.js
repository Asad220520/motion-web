      ...
      <GoChevronDown style={{fontSize:'25px'}} />
          ...
          className="program--group__block--ims__text">
            ...
            >
              ...
              >
                <div
                  style={{ alignItems: blo1 ? "start" : "center" }}
                ...
                >
                  <div className="program--group__block--ims__text--grou">
                    <p>
                      В этом модуле вы получите представление о том,
                      в чем разница между UX и UI, а также почему они неразрывно
                      связаны между собой. Мы обсудим, что такое интерфейс
                      и затронем тему классификации дизайна и сайтов.
                      Вы узнаете, какими принципами и в каком порядке важно
                      руководствоваться в процессе проектирования, получите
                      представление о том, как пользователи обрабатывают данные,
                      изучите приёмы управления их вниманием и эмоциями.
                      Научитесь работать в графическом редакторе Figma
                      и пройдёте первые этапы погружения в UX/UI-дизайн.
                    </p>
                    <ul>
            ...
            >
              ...
              >
                <div
                  style={{ alignItems: blo3 ? "start" : "center" }}
                  className="program--group__block--ims__img"
                >
                  <div
                    style={{ alignItems: blo3 ? "start" : "center" }}
                ...
                >
                  <div className="program--group__block--ims__text--grou">
                    ...
                    <ul>
                      <li>
                        Создание прототипов и макетов пользовательского
                        интерфейса.
                      </li>
                      <li>Работа с wireframes (скетчи интерфейса).</li>
                      <li>
                        Проектирование пользовательских путешествий (user
                        journey) и потоков пользовательских действий.
                      </li>
                      <li>
                        Принципы дизайна пользовательского интерфейса (цвет,
                        типографика, пропорции и т.д.).
                      </li>
                      <li>
                        Создание стилевых концепций и элементов интерфейса.
                      </li>
            ...
            >
              ...
              >
                <div
                  style={{ alignItems: blo4 ? "start" : "center" }}
                  className="program--group__block--ims__img"
                >
                  <div
                    style={{ alignItems: blo4 ? "start" : "center" }}
                ...
                >
                  <div className="program--group__block--ims__text--grou">
                    ...
                    <ul>
                      <li>
                        Использование инструментов для создания интерактивных
                        прототипов (например, Sketch, Figma, Adobe XD).
                      </li>
            ...
            >
              ...
              >
                <div
                  style={{ alignItems: blo5 ? "start" : "center" }}
                  className="program--group__block--ims__img"
                >
                  <div
                    style={{ alignItems: blo5 ? "start" : "center" }}
            ...
            >
              ...
              >
                <div
                  style={{ alignItems: blo6 ? "start" : "center" }}
                  className="program--group__block--ims__img"
                >
                  <div
                    style={{ alignItems: blo6 ? "start" : "center" }}
                ...
                >
                  <div className="program--group__block--ims__text--grou">
                    ...
                    <ul>
                      <li>
                        Как представлять свои дизайн-решения клиентам или
