...
const Glav = () => {
  return (
      ...
      <div className="himages--group__block">
        <h1><span>UI/UX <br /> </span>DESIGN</h1>
        
        <p>UX/UI-дизайн — это процесс создания интерактивных, 
            удобных интерфейсов. Отличный вариант профессии для творческих людей, которым нравится решать проблемы пользователей
             и создавать что-то новое, сочетая логику и эстетику.</p>
