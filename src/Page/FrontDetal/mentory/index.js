    ...
    <div id='mentory'>
      <div className="container">
        <div className="mentory">
            <h2><span>Лучшие менторы </span>по всему Кыргызстану</h2>
            ...
            <div className="mentory--group__block--img">
                ...
                <p>Ментор по UI/UX дизайну. Работал в амерканской компании и на фрилансе.
                     На счёту 200+ успешных проектов.</p>
            </div> 
             <div className="mentory--group__block ">
            <div className="mentory--group__block--img">
                <img src={men} alt="img" />
            ...
            <div className="mentory--samai">
                <div className="mentory--samai__text">
                    ...
                    <p>Наши менторы дают подробный разбор ваших работ, отмечают 
                        ошибки и помогают их исправить.</p>
                </div>
